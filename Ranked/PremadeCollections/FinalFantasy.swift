...
func createFinalFantasyCollection() -> CollectionModel {
    ...
    let item2 = ItemModel(name: "Final Fantasy II", image: "FinalFantasy2")
    ...
    let item10 = ItemModel(name: "Final Fantasy X", image: "FinalFantasy10")

    let item11 = ItemModel(name: "Final Fantasy XI", image: "FinalFantasy11")

    let item12 = ItemModel(name: "Final Fantasy XII", image: "FinalFantasy12")

    let item13 = ItemModel(name: "Final Fantasy XIII", image: "FinalFantasy13")

    let item14 = ItemModel(name: "Final Fantasy XIV", image: "FinalFantasy14")

    let item15 = ItemModel(name: "Final Fantasy XV", image: "FinalFantasy15")
